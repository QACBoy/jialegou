...
import com.hilkr.dal.dao.OrderStatusMapper;
...
public class UpdateOrderStatusListener {
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "jialegou.order.delay.ttl.queue", durable = "true"), //队列持久化
            exchange = @Exchange(
                    value = "jialegou.amq.direct",
                    ignoreDeclarationExceptions = "true",
                    type = ExchangeTypes.TOPIC
            ),
            key = {"jialegou_ttl_orderStatus"}
    ))
