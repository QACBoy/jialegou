...
import com.hilkr.order.client.AlipayClient;
...
public class OrderController {
    ...
    public ResponseEntity<String> generateUrl(@PathVariable("id") Long orderId) {
        ...
        String url = this.alipayClient.generateUrl(orderId);
        // String url = "https://qr.alipay.com/bax02587xbgmfhnxjkst00c8";
    ...
    public ResponseEntity<Integer> queryPayState(@PathVariable("id") Long orderId) {
        PayState payState = this.alipayClient.queryOrder(orderId);
        if (payState.getValue() == 1) {
