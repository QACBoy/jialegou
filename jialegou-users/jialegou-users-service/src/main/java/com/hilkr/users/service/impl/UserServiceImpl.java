...
public class UserServiceImpl implements IUserService {
    ...
    private static final String KEY_PREFIX2 = "jialegou:user:info";
    ...
    public Boolean checkData(String data, Integer type) {
        ...
        return this.userMapper.selectCount(new QueryWrapper<User>().setEntity(user)) == 0;
    }
    ...
    public Boolean sendVerifyCode(String phone) {
        ...
        try {
            ...
            msg.put("code", code);
            //2.发送短信
            this.amqpTemplate.convertAndSend("jialegou.sms.exchange", "sms.verify.code", msg);
    ...
    public User queryUser(String username, String password) {
        ...
        if (StringUtils.isEmpty(userStr)) {
            ...
            user = this.userMapper.selectOne(new QueryWrapper<User>().setEntity(record));
