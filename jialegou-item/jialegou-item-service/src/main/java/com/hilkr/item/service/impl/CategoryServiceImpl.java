...
public class CategoryServiceImpl implements ICategoryService {
    ...
    public void saveCategory(Category category) {
        ...
        this.categoryMapper.updateById(parent);
    ...
    public void deleteCategory(Long id) {
        ...
        if (category.getIsParent()) {
            ...
            for (Category c : list2) {
                this.categoryMapper.deleteById(c.getId());
            }
            ...
            if (list.size() != 1) {
                //有兄弟,直接删除自己
                this.categoryMapper.deleteById(category.getId());
    ...
    public List<String> queryNameByIds(List<Long> asList) {
        ...
        if (asList != null && asList.size() != 0) {
            for (Long id : asList) {
                names.add(this.categoryMapper.selectById(id).getName());
            }
        }
        return names;
    ...
    public List<Category> queryCategoryByIds(List<Long> ids) {
        return this.categoryMapper.selectBatchIds(ids);
    }
